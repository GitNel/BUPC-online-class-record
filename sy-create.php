                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title"><i class="fa fa-calendar"></i> Create New School Year</h2>
                            </div>
                            ...
                            <div class="row">
                                ...
                                if(isset($_GET['error']) == "alAva"){ ?>
                                        <div class="alert alert-danger left-icon-alert alert-dismissible fade in text-center">
                                            ...
                                            <strong>School Year is Already Available!</strong>
                                        </div>
                                        <?php    }
                            ?>

                                        <div class="panel-title">
                                            <h3><i class="fa fa-calendar"></i> New School Year</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="process/schlyr/pr-schoolyr.php" method="POST">
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">School Year Name</label>
                                                <div class="">
                                            ...
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Class Start</label>
                                                <div class="">
                                            ...
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Class End</label>
                                                <div class="">
