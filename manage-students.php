                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li><i class="fa fa-users"></i> Manage Student List</li>
                                </ul>
                            </div>
                                    ...
                                    ?>
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <h5><i class="fa fa-file-text"></i> View Each Class Students List</h5>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body p-20">
                                            ...
                                            <table id="example" class="display table table-striped table-bordered text-center" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php 
                                                        $subjlist = SubjListperUser($conn, $_SESSION['USER']);
                                                    ...
                                                    <tr>
                                                       <td><?php echo $no?></td>
                                                        ...
                                                        <td>
                                                            <a href="manage-student-list.php?subjectid=<?php echo $val['subj_id']?>"><i class="fa fa-list" title="View Record"></i> </a>
