                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title"><i class="fa fa-bar-chart"></i> Manage Criteria</h2>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="#"><i class="fa fa-bar-chart"></i> Manage Criteria</a></li>
                                </ul>
                            </div>
                                            ...
                                            <table id="example" class="display table table-striped table-bordered text-center" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>School Year</th>
                                                        <th>Status</th>
                                                        <th>Add Equivalence</th>
                                                        <th>Visit Criteria</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php 
                                                        $subjlist = AllCriteria($conn, $_SESSION['USER']);
                                                    ...
                                                    <tr>
                                                       <td><?php echo $no?></td>
                                                        ...
                                                        <td><?php echo $val['crit_stat']?></td>
                                                        
                                                        <td>
                                                            <a href="eachcrit-equi.php?critid=<?php echo $val['crit_id']?>"><i class="fa fa-edit" title="Edit Record"></i> </a>

                                                        </td>
                                                        <td>
                                                            <a href="manage-grading.php?critid=<?php echo $val['crit_id']?>"><i class="fa fa-list" title="Visit Record"></i> </a>
