                                        ...
                                        <div class="panel-body p-20">
                                            ...
                                            <table id="example" class="display table table-striped table-bordered text-center" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    $critid = "";
                                                        $critid = htmlentities($_GET['critid']);
                                                        $arr = StudListPerSubj($conn, $critid);
                                                        foreach($arr as $key => $val){
                                                        $no = $key;
                                                        $no++;
                                                ?>
                                                    ...
                                                    $critid = "";
                                                        $critid = htmlentities($_GET['critid']);
                                                        $arr = EachActPerSubj($conn, $critid);
                                                        foreach($arr as $key => $val){
                                                ?>
                                                    ...
                                                    $stud = "";
                                                        ...
                                                        foreach($arr as $key => $val){
                                                            ...
                                                            if(empty($val['tally_pts_get'])){ ?>
                                                            <a href="ptsget" data-toggle="modal" data-target="#ptsget">Input</a>
                                                            <?php    }
                                                            else{
                                                                echo $val['tally_pts_get'];
                                                            }
                                                        }
                                                            ?>
