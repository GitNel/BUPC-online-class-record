...
<body class="top-navbar-fixed">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title"><i class="fa fa-building-o"></i> Departments</h2>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="#"><i class="fa fa-building-o"></i> Manage Department</a></li>
                                </ul>
                            </div>
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="col-md-8 col-md-offset-2">
                                                ...
                                                <div class="alert alert-success left-icon-alert alert-dismissible fade in text-center indal">
                                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                    <strong> Department Successfully Edited!</strong>
                                                </div>
                                                <?php    }
                                            ...
                                            <div class="panel-title">
                                                <h3><i class="fa fa-file-text"></i> View Department Info</h3>
                                            </div>
                                        </div>
                                            ...
                                            <table id="example" class="display table table-striped table-bordered text-center" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        $classlist = DisplayDeptuser($conn);
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a dept-id="<?php echo $val['dept_id']?>" onclick="Editdept(this);"><i class="fa fa-edit" title="Edit Record"></i> </a>
    ...
    <!--    ---------------Edits the details of the department---------------------------->
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="process/deprtmnt/pr-upd-dept.php" id="Edit-dept">
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Edit Department Name</label>
                                                <div class="">
                                            ...
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Edit Department Code</label>
                                                <div class="">
    ...
    <script>
        function Editdept(self) {
            var id = self.getAttribute("dept-id");
