                ...
                <div class="main-page">
                    ...
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title"><i class="fa fa-graduation-cap"></i> Course Creation</h2>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="#"><i class="fa fa-graduation-cap"></i> Create New Course</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                if(isset($_GET['error']) == "alAva"){ ?>
                                        <div class="alert alert-danger left-icon-alert alert-dismissible fade in text-center">
                                            ...
                                            <strong>Course is Already Available!</strong>
                                        </div>
                                        <?php    }
                            ?>
                                    </div>
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h5><i class="fa fa-graduation-cap"></i> Create Course</h5>
                                        </div>
                                    </div>

                                    <div class="panel-body">

                                        <form action="process/course/pr-nwcourse.php" method="POST">
