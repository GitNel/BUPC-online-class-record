...
<body class="top-navbar-fixed">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title"><i class="fa fa-bar-chart"></i> Grading</h2>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li><i class="fa fa-bar-chart"></i> Grading</li>
                                    <li><a href="manage-crit.php"><i class="fa fa-bar-chart"></i> Manage Criteria</a></li>
                                    <li><a href="#"><i class="fa fa-bar-chart"></i> Class Grades</a></li>
                                </ul>
                            </div>
                                    ...
                                    ?>
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <div class="col-md-6">
                                                    <h5><i class="fa fa-file-text"></i> View Grading List</h5>
                                                </div>
                                            ...
                                            <table id="example" class="display table table-striped table-bordered text-center" cellspacing="0" width="100%">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><a grad-id="<?php echo $grad['grad_id']?>" crit-id="<?php echo $grad['crit_id']?>" onclick="ShowGradId(this);"><?php echo $grad['grad_name']?> <span class="ml-10"> <i class="fa fa-ellipsis-v mylist"></i></span></a></th>
                                                        <?php }
                                                        ?>
                                                    ...
                                                    // * huwag mag muna mag tally ng points kada assessment kapag dipa na finalize ang list student .. error alert
                                                        ...
                                                        foreach($arr as $key => $stdgrades){ 
                                                               ...
                                                               $sql = "SELECT * FROM tbltallypts t
                                                                        ...
                                                                        WHERE c.crit_id = ?;"; //this will check if the subj id is available in the tallypts table
                                                                ...
                                                                mysqli_stmt_bind_param($stmt, "s", $_GET['critid']);
                                                        ...
                                                        <td>
                                                            ...
                                                            <a data-id="<?php echo $tally['tally_id']?>" onclick="Editpoints(this);" val="<?php echo $tally['crit_id']?>" totpts="<?php echo $tally['grad_tot_pts']?>">Input / <?php echo $tally['grad_tot_pts']?></a> <!-- Display to input a grade -->

                                                            <?php    }
                                                            else{ ?>
                                                            <div class="col-md-12">
                                                                <a><?php echo $tally['tally_pts_get'] . " " . "/" . " " . $tally['grad_tot_pts']?></a>
                                                                <span class="pl-20"><a data-id="<?php echo $tally['tally_id']?>" onclick="Editpoints(this);" val="<?php echo $tally['crit_id']?>" totpts="<?php echo $tally['grad_tot_pts']?>"><i class="fa fa-ellipsis-v mylist"></i></a></span>
                                                            </div>
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="process/grading/pr-upd-stud-pts.php" id="Edit-pts">
                                            <div class="form-group has-success">
                                                ...
                                                <input type="number" name="totpts" min="0" max="100" class="form-control" required>
                                            </div>
    ...
    <script>
        function Editpoints(self) {
            ...
            var crit = self.getAttribute("val");
            var total = self.getAttribute("totpts");

            document.getElementById("Edit-pts").id.value = id;
            document.getElementById("Edit-pts").crit.value = crit;
            document.getElementById("Edit-pts").total.value = total;
            $("#myModal").modal("show");
