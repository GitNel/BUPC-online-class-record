                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title"><i class="fa fa-users"></i> Create Student Class</h2>
                            </div>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="#"><i class="fa fa-users"></i> Create Class</a></li>
                                </ul>
                            </div>
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h3><i class="fa fa-users"></i> New Class</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="process/class/pr-nwclass.php" method="POST">
